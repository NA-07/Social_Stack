...
function Profile() {
  ...
  const profileInitials = `${user?.fname?.[0] || "U"}${user?.lname?.[0] || ""}`.toUpperCase();

  return (
    <Card className="my-10 w-[100%]">
      <div className="rounded-md">
        <div className="h-[15rem]">
          <div className="h-full w-full rounded-t-md bg-gradient-to-br from-slate-900 via-slate-700 to-cyan-700" />
        </div>
